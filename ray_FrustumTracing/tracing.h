...
namespace Tracing
{
	...
	void AddImpulseResponse(vector<vector<double>>& hrir, const vector<COMPLEX>& sDrct, vector<int> refs, vector<int> mirs, vector<int> scats, int band, Vector4f vec, int id, double len_s, bool scatFlag = false);
